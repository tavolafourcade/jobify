...
const getAllJobs = async (req, res) => {
  ...
  const totalJobs = await Job.countDocuments(queryObject); // count the total number of jobs
  const numOfPages = Math.ceil(totalJobs / limit); // calculate the number of pages
